...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='ConvIRSRRS', type=str)
    parser.add_argument('--data', type=str, default='SRRS', choices=['CSD', 'SRRS', 'Snow100K'])

    parser.add_argument('--data_dir', type=str, default=r'D:\projects\PycharmProjects\ConvIR-main\ConvIR-main\Image_desnowing\datasets\SRRS')
    parser.add_argument('--mode', default='dense', choices=['dense', 'train'], type=str)
    ...
    # Test
    parser.add_argument('--test_model', type=str, default=r'D:\projects\PycharmProjects\ConvIR-main\ConvIR-main\Image_desnowing\SRRSBest.pkl')
